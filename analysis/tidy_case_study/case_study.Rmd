---
title: "WHO Tuberculosis Data Exploration"
...
# TL:DR
Today I am going to dive into some real life data from the World Health Organization (WHO), exploring new and relapse cases of Tuberculosis.  We clean up the data, and then make a few graphs to explore different variables.
...
```{r}
who_raw <-  read.csv("../../data_public/raw/TB_notifications_2020-02-11.csv")
...
gpd_raw <-  read.csv("../../data_public/raw/API_NY.GDP.PCAP.CD_DS2_en_csv_v2_713080.csv",
                     skip = 4)
...
```{r}
pop_raw <-  read.csv("../../data_public/raw/API_SP.POP.TOTL_DS2_en_csv_v2_713131.csv"
                     ,skip = 4)
